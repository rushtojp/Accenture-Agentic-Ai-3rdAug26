/* =====================================================================
   ...
   BUILD STATUS: Day 3 labs 1-6 are BUILT and EXECUTED. Lab 6 is the gap-G3
   remediation (human-in-the-loop) and unblocks the Capstone. Slide 10 lists all
   six. Figures on slides 3 and 11 are measured from real runs of Lab 1.
   ===================================================================== */
...
TIME: 8 min`,
  ...
  /* --------------------------------------------------------------- 10 */
  {
    ...
    subtitle: "Six labs, roughly 4 hours 35 minutes. Each extends the 13-node Day 2 pipeline directly.",
    steps: [
      ...
      { n: "6", h: "Human-in-the-loop · 50 min", b: "GAP G3 REMEDIATION. interrupt() and a durable checkpointer, so QUERY suspends and resumes instead of terminating. Unblocks the Capstone." },
    ],
    notes: `WHY: Orientation, plus one point of delivery honesty that matters.

SAY: "Six labs, not five. Lab 6 is new - it is the human-in-the-loop remediation that closes gap G3, and without it the Capstone cannot be built as drawn. Protect time for it even if that means shortening Labs 1 and 2."
...
TIME: 6 min`,
  ...
  /* --------------------------------------------------------------- 12 */
  {
    ...
    cards: [
      { icon: "✓", h: "Human-in-the-loop", b: "CLOSED by Lab 6. interrupt() plus a durable SqliteSaver checkpointer; QUERY now suspends and resumes with attribution. Capstone criteria 5 and 6 unblocked.", tag: "GAP G3 · CLOSED" },

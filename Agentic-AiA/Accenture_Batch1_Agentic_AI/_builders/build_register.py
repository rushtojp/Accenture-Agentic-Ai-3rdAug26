...
sheet(
    ...
    [
        ["G3", "Human-in-the-loop not taught", "Curriculum", "HIGH", "OPEN",
         "Capstone QUERY state needs LangGraph interrupt + checkpointer. No Day 1-3 lab teaches either. verify_environment.py checks the import and warns.",
         "Build a ~50-minute remediation lab BEFORE capstone delivery. Without it, learners can route to QUERY but not resume from it, and the capstone architecture cannot be implemented as drawn.",
         1],
...
sheet(
    ...
    [
        ...
        ["A5", "LangGraph interrupt / Command (HITL)",
         "Post-0.2 API. Required by the Capstone QUERY state. Not exercised in Days 1-3 as scoped.", "MEDIUM",
         "verify_environment.py imports langgraph.types.interrupt and warns if absent. Checkpoint package pinned.",
         "Run the verifier. See Open Question G3."],
...
sheet(
    ...
    [
        ...
        ["Day 3", "Deck — 13 slides", "DESIGN ONLY", "n/a",
         "Design-locked AHEAD of the labs. Lab-referencing slides describe intended labs. Re-verify after the labs land."],
        ["Day 3", "Facilitation guide (Word)", "DESIGN ONLY", "n/a", "Same caveat as the deck."],
        ["Day 3", "Labs 1-5", "NOT BUILT", "no", "Input gates, output redaction, audit logging, secured nodes, scenario matrix."],
        ["Day 3", "Webapp — guardrail sandbox", "NOT BUILT", "no", ""],
        ...
        ["Capstone", "src / webapp / build guide", "NOT BUILT", "no",
         "BLOCKED on Open Question G3 (human-in-the-loop). Acceptance criteria 5 and 6 cannot be met without it."],
        ["Remediation", "HITL lab (closes gap G3)", "NOT BUILT", "no", "Highest-priority outstanding item."],
    ],
    sev_col=3, freeze="A5",
)

...
def route_security(state: SecuredState) -> str:
    ...
    # <<<BLANK hint="Return 'security_hold' if any flag has severity 'block'; 'flagged' if there are flags but none blocking; otherwise 'clear'">
...
# <<<BLANK hint="add_conditional_edges from 'input_guardrail' using route_security, mapping 'security_hold'->'security_hold', 'flagged'->'flagged', 'clear'->'rule_engine'">
builder.add_conditional_edges("input_guardrail", route_security,

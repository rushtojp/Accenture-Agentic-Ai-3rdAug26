...
def route_on_confidence(state: RagState) -> str:
    ...
    # <<<BLANK hint="Return 'query' when code is 'UNKNOWN' or confidence < CONFIDENCE_FLOOR, else 'dispute'">
    if code == "UNKNOWN" or confidence < CONFIDENCE_FLOOR:
        return "query"
    return "dispute"
    # >>>
...
# <<<BLANK hint="add_conditional_edges from 'classify_deduction' using route_on_confidence, mapping 'dispute'->'open_dispute' and 'query'->'query'">
builder.add_conditional_edges("classify_deduction", route_on_confidence,

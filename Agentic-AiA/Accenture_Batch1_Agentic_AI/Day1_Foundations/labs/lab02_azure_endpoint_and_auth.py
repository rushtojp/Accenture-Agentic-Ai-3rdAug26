# ==========================================================================
# STARTER FILE - Day 1 Lab 2 - Azure AI Endpoint Integration and Client Authentication
# ==========================================================================
...
# ------------------------------------------------------------------
# TODO (Blank 1): Call demo.get_token() with scope 'https://cognitiveservices.azure.com/.default' and store it in `token`
# ------------------------------------------------------------------
...
# ------------------------------------------------------------------
# TODO (Blank 2): Call client.complete() with SYSTEM and REMITTANCE at temperature 0.0; store in `answer`
# ------------------------------------------------------------------

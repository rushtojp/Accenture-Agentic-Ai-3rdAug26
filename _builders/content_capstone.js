/* =====================================================================
   ...
   BUILD STATUS: the Capstone BUILD (src/, webapp/) is not yet produced, but its
   blocking dependency is CLEARED - gap G3 is closed by Day 3 Lab 6. Acceptance
   criteria 5 and 6 are now reachable. This deck remains design-locked ahead of
   the build; re-verify references against the built artifacts before delivery.
   ===================================================================== */
...
TIME: 6 min`,
  ...
  /* ---------------------------------------------------------------- 5 */
  {
    ...
    callout: "Criteria 5 and 6 depend on durable checkpointing and LangGraph interrupt — gap G3, now CLOSED by Day 3 Lab 6. Both are reachable. Confirm Lab 6 was delivered before promising them.",

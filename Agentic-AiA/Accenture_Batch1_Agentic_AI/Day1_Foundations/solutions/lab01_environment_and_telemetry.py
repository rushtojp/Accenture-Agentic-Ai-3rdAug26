...
# <<<BLANK hint="Call configure() with level 'INFO' and logfile 'lab01_audit.log'">
configure(level="INFO", logfile="lab01_audit.log")
# >>>
...
with trace_node(log, "rule_engine", run_id, txn_id="BNK-1002") as out:
    # <<<BLANK hint="Record priority=1, match_type='2-way', matched_invoice='INV-810' in `out`">
    out["priority"] = 1
    out["match_type"] = "2-way"
    out["matched_invoice"] = "INV-810"
    # >>>
